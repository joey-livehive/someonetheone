...
function initialStageFromQuery(value: string | null): Stage {
...
export function MeetOrPassCta() {
  ...
  const [stage, setStage] = useState<Stage>(() =>
    initialStageFromQuery(searchParams?.get('cta') ?? null),
  );
  ...
  return (
    <div className="px-7 mt-10">
      <div className="bg-brand-ink text-brand-cream rounded-[20px] p-5 border-[1.5px] border-brand-line">
        <div className="font-display font-bold text-[22px] mb-2 leading-[1.3]">
          {heading}
        </div>
        <div className="text-[13.5px] text-brand-cream/75 leading-[1.6] mb-5">
          {subheading}
        </div>
