  ...
  return (
    <div className="letter">
      <div className="letter-head">
        ...
        <span className="letter-from">from your casting manager</span>
      </div>
      <h2>
        선택지에서 읽어낸
        <br />
      ...
      <div className="letter-foot">
        <div className="letter-probability">
          <span className="letter-probability-label">예상 만족도</span>
          <span className="letter-probability-val">
            89<sup>%</sup>
          </span>
        </div>
        <span className="letter-cases">BASED ON 23,481 CASES</span>
      </div>
    </div>
  );
}
