...
const femaleReport: ReportData = {
  ...
  match: {
    ...
    simulation: '첫 만남은 <b>조용한 와인바</b>가 어울릴 거야. 이 분은 시끄러운 곳보다 대화가 자연스럽게 흘러가는 공간을 선호해. 의뢰인님도 비슷한 걸 편안해하잖아. 둘 다 술을 많이 먹는 타입은 아니라서, 한 잔 두고 <b>2~3시간 얘기</b>하는 게 딱이야. 두 번째 만남쯤엔 이 분이 먼저 <b>작은 디테일</b>을 기억해서 꺼낼 거야. 그때 네가 "어, 그거 기억해?"라고 놀라는 표정 지으면, 이 분 속으로 웃을 거야. 그런 타입이거든.',
    notes: [
...
const maleReport: ReportData = {
  ...
  match: {
    ...
    simulation: '첫 만남은 <b>작은 전시</b>가 어울릴 거야. 이 분은 큰 데이트보다 일상 속 장소에서 서로의 반응을 보는 걸 더 좋아해. 의뢰인님도 조용한 공간에서 더 편해지잖아. 전시 한 바퀴 돌고, 근처 <b>작은 와인바에서 한 잔</b>이 딱이야. 두 번째 만남엔 이 분이 자기 작업 얘기를 슬쩍 꺼낼 거야. 처음 만났을 땐 거의 안 해. 네가 <b>진지하게 듣는 태도</b>만 보여줘도, 이 분 속으로 엄청 긍정적으로 평가할 거야.',
    notes: [
...
const femaleReportFormal: ReportData = {
  ...
  match: {
    ...femaleReport.match,
    simulation:
      '첫 만남은 <b>조용한 와인바</b>가 어울릴 거예요. 이 분은 시끄러운 곳보다 대화가 자연스럽게 흘러가는 공간을 선호하세요. 의뢰인님도 비슷한 걸 편안해하시잖아요. 둘 다 술을 많이 드시는 타입은 아니라서, 한 잔 두고 <b>2~3시간 얘기</b>하는 게 딱이에요. 두 번째 만남쯤엔 이 분이 먼저 <b>작은 디테일</b>을 기억해서 꺼낼 거예요. 그때 "어, 그거 기억하세요?"라고 놀라는 표정 지으시면, 이 분 속으로 웃으실 거예요. 그런 타입이시거든요.',
    notes: [
...
const maleReportFormal: ReportData = {
  ...
  match: {
    ...maleReport.match,
    simulation:
      '첫 만남은 <b>작은 전시</b>가 어울릴 거예요. 이 분은 큰 데이트보다 일상 속 장소에서 서로의 반응을 보는 걸 더 좋아하세요. 의뢰인님도 조용한 공간에서 더 편해지시잖아요. 전시 한 바퀴 돌고, 근처 <b>작은 와인바에서 한 잔</b>이 딱이에요. 두 번째 만남엔 이 분이 자기 작업 얘기를 슬쩍 꺼내실 거예요. 처음 만나셨을 땐 거의 안 하시거든요. <b>진지하게 듣는 태도</b>만 보여주셔도, 이 분 속으로 엄청 긍정적으로 평가하실 거예요.',
    notes: [
